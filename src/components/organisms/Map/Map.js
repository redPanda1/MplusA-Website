...
const Map = props => {
  ...
  React.useEffect(() => {
    ...
    const markerIcon2x = require('assets/images/marker-icon-2x.png');
    const markerIcon = require('assets/images/marker-icon.png');
    const markerShadow = require('assets/images/marker-shadow.png');
